...
Use AskUserQuestion to resolve what the references don't settle — e.g., accent color, light/dark preference, single-page vs. multi-page, which sections to keep or drop (this site has: about, news, dissertation, publications, working papers, projects, talks, teaching, software, blog — see the table in `CLAUDE.md`). Present your design brief and get sign-off before writing code.
