...
I study the relationship between social media algorithms and democracy, focusing on questions such as how these algorithms 
shape individuals’ political attitudes (e.g., partisan animosity, affective polarization) and behaviors 
(e.g., informed decision-making, civic engagement, intergroup cooperation), and how platform designs can better support 
democratic processes. My research is crucial in bridging the growing political divide and identifying ways to promote a 
healthier democracy in the digital age. 

As a computational social scientist, I view my research as a problem-solving endeavor. 
Specifically, this involves describing the problem at hand, explaining its underlying mechanisms, 
and identifying cost-effective and scalable interventions to address it. 
To do so, I  combine surveys with online field experiments, leveraging existing social media affordances to 
conduct randomized controlled trials that intervene in users' experiences. 
Through my research, I aim to generate evidence-based solutions that can inform platform designs and policies, 
ultimately promoting a more democratic, inclusive, and prosocial online public sphere.
